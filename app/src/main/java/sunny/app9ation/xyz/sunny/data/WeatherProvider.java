 ...
 */
package sunny.app9ation.xyz.sunny.data;
...
public class WeatherProvider extends ContentProvider {
    ...
    private Cursor getWeather(Uri uri , String[] projection, String sortOrder,String selection, String[] selectionArgs){
    ...
    private Cursor getLocation(Uri uri , String[] projection, String sortOrder, String selection, String[] selectionArgs){
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            // "weather"
            case WEATHER: {
                retCursor = getWeather(uri,projection,sortOrder, selection, selectionArgs);
                break;
            }
            // "location"
            case LOCATION: {
                retCursor = getLocation(uri,projection,sortOrder,selection,selectionArgs);
                break;
            }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match){
            ...
            default:
                throw new UnsupportedOperationException("Failed to delete row "+rowDeleted);
        }
            ...
            Uri uri, ContentValues values, String selection, String[] selectionArgs)
    {
        ...
        switch (match){
            ...
            default:
                throw new UnsupportedOperationException("Failed to update row "+rowUpdated);
        }
